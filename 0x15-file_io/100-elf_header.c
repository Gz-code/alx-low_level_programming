...
/**
 * check_elf - Code checks if a file is an ELF file.
 * @e_ident: The pointer to an array with the ELF magic numbers.
 *
...
/**
 * print_magic - This will prints the magic numbers of an ELF header.
...
/**
 * print_data - This will prints the data of an ELF header.
 * @e_ident: The pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_osabi - This will prints the OS/ABI of an ELF header.
...
/**
 * main - Main willDisplay the information contained in the
